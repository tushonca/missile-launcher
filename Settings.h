...
/* --------- -------- ---------*/
 ...
 /*         ------ просто  знайте ------
 * <5> - ручной / автоматический режимы (SwA) 2п
 * <6> - вкл / выкл сигнал на включение пищалки (SwB) 2п
 * <7> - пуск / ничего (авто режим)(SwD) 2п
 * <8> - выкл / вкл экстренный парашют (SwF) 2п
 * <9> - вкл / ничего подтверждение (SwH) 2п бф
 * <10> - ничего / пуск первой / пуск второй ступени (ручной режим) (SwC) 3п
 *  - - - положения - - - в меню пульта SERVO
 * /\  306  верх       (1)  1916
 * ||  1000  середина  (3)  1500
 * \/  1694  низ       (2)  1084
 */
/*
 * Переферия :
